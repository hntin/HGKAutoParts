 ...
 * @author HNTIN
 */
public class QuanLyNguoiDungActionSupport extends ActionSupport {
    ...
    public String execute() throws Exception {
        ...
        if (selectedLoaiND != null) {
            if (selectedLoaiND.equals("0")) {
                dsNguoiDungDTO = nguoidungBO.getDSNguoiDung("", "");
            } else {
                dsNguoiDungDTO = nguoidungBO.getDSNguoiDung("", "", selectedLoaiND);
            }
        }
